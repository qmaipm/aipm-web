...
const faq = [
  ...
  { q: "净利率从 3.4% 到 14%，换算成钱是什么概念？", a: "同样收 100 元物业费，传统模式最后剩 3.4 元利润，爱物管剩 14 元。差额不是来自涨价或砍一线服务，而是中间管理层从 69 人到 5 人省下的管理成本。该数据为小规模自营验证结果，非行业普遍值。" },
      ...
      <section className="cf-band">
        <div className="wrap">
          <div className="cf-article">
            ...
            <p>把净利率翻译成钱，这张表会更直观：<b>同样收 100 元物业费，传统模式最后剩 3.4 元利润，爱物管剩 14 元。</b>多出来的部分不是涨价涨出来的，也不是砍一线服务省出来的，而是中间那层管理成本被 AI 省掉了。</p>
