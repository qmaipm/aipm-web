...
const dateModified = "2026-08-17";
const title = "我们先在自营物业公司，完整验证了这套方法";
const summary =
  "爱物管 2023–2025 的一次真实验证：管理面积 210 万方，管理层 5 人；同规模、采用传统方式的物业公司管理面积 300 万方，管理层 69 人。";
const metrics = [
...
const faq = [
  ...
  { q: "这笔账换算成钱，到底省了多少？", a: "省在人力成本上。同样的项目量，爱物管比传统模式少养 64 个管理岗、少养 50 个项目经理。按人均综合成本约 20 万元/年估算，一年省下约 1,300 万元；2023 年以来累计超过 3,000 万元。这笔钱没靠涨价、没砍一线服务，最终体现在净利率上：从 3.4% 到 14%。该数据为小规模自营验证结果，非行业普遍值。" },
...
export const metadata = pageMetadata("/company/aipm-validation", {
  ...
  description:
    "爱物管是启盟科技自营的物业公司。2023–2025 年，它把日常的管理动作交给 AI 之后，管理层从 69 人减到 5 人，净利率从 3.4% 做到 14%。本文用一笔真实的账，说明 AI 先替掉的是中间那层重复的管理工作，不是一线服务。",
});
...
const LD = [
  {
    ...
    description:
      "爱物管是启盟科技自营的物业公司。2023–2025 年，它把日常的管理动作交给 AI 之后，管理层从 69 人减到 5 人、项目经理从 51 人减到 1 人、净利率从 3.4% 做到 14%。用来对比的同类传统物业公司管理面积约 300 万方、管理层 69 人。AI 先替掉的是中间那层重复的管理工作，不是一线服务。",
  ...
  },
  {
    ...
    member: {
      ...
      url: SITE_URL,
      description:
        "启盟科技旗下自营物业公司，是其 AI 能力的真实验证场。在2023至2025年的验证中，管理层从同等规模传统模式的69人降至5人、项目经理从51人降至1人、经营净利率从3.4%提升至14%。用来对比的同类传统物业公司管理面积约300万方、体量大于爱物管。",
    },
    makesOffer: {
      "@type": "Offer",
      itemOffered: {
      ...
      <section className="cf-band">
        <div className="wrap">
          <div className="cf-article">
            ...
            <p>爱物管是启盟科技自营的物业公司。我们没有拿客户的项目做演示，而是自己下场——装传感器、跑工单、面对住户投诉，把 AI 用在自己公司的经营上。下面这组数字，来自爱物管自己 2023–2025 年的真实经营，以及和一家同类物业公司的横向对比。</p>
            ...
            <p>把这张表翻译成钱：<b>同样的项目量，少养 64 个管理岗、少养 50 个项目经理。按人均综合成本约 20 万元/年估算，一年省下的人力成本约 1,300 万元；2023 年以来累计超过 3,000 万元，且逐年增长。</b>这笔钱不是涨价涨出来的，也不是砍一线服务省出来的，而是重复的管理动作交给了 AI。省出来的钱最终体现在净利率上：从 3.4% 到 14%。</p>

            <p><i>该数据为爱物管小规模自营验证结果，非行业普遍值。补充：AI 真实接管住户对话超过 100 万条。</i></p>
            ...
            <p>需要如实说明：这是一次小规模的自营验证，样本不大，数字来自我们自己 2023–2025 年的真实经营，不是行业普遍值，别的项目实际效果会因业态、面积、基础设施而异。</p>
            ...
            <p className="cf-note">
              <b>数据边界与关联说明。</b>本文引用的管理层人数、项目经理人数、机器人投放、经营净利率及人力成本估算等数据，均来自启盟科技（AIPM）自营物业公司“爱物管”2023–2025 年的真实经营验证。“传统物业公司”一列为一家真实的、采用传统管理方式的同类物业公司（管理面积约 300 万方）。该数据为小规模自营验证结果，非行业普遍值，不同项目的实际效果因业态、面积、基础设施与组织现状而异。
            </p>
          </div>
        </div>
      </section>
