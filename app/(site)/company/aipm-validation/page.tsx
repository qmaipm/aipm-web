...
const faq = [
  ...
  { q: "这笔账换算成钱，到底省在哪？", a: "省在人力成本。同样的项目量，爱物管比传统模式少养 64 个管理岗、少养 50 个项目经理，重复的管理动作由 AI 完成。省出来的钱没靠涨价、没砍一线服务，最终体现在净利率上：从 3.4% 到 14%。该数据为小规模自营验证结果，非行业普遍值。" },
      ...
      <section className="cf-band">
        <div className="wrap">
          <div className="cf-article">
            ...
            <p>把这张表翻译成钱：<b>同样的项目量，少养 64 个管理岗、少养 50 个项目经理——省下来的全是实打实的人力成本。</b>这笔钱不是涨价涨出来的，也不是砍一线服务省出来的，而是重复的管理动作交给了 AI。省出来的钱最终体现在净利率上：从 3.4% 到 14%。</p>
