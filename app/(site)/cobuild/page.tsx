...
export default function Page() {
  return (
    <main className="cobuild">
      {/* HERO */}
      <section className="phero">
        <div className="hero-mesh"></div>
        <div className="wrap">
          <span className="eyebrow reveal">人工智能产业共建</span>
          <h1 className="reveal" style={{ marginTop: "20px" }}>来本地投资兴业,<br />与贵区<span className="grad">共建本地人工智能产业</span></h1>
          <p className="lead reveal">这不是一次试点采购。我们带着资金、技术与运营团队来本地落地,与贵区一起承接国家人工智能产业战略——产业、税收、就业与数据资产,沉淀在本地。</p>
        </div>
      </section>

      {/* 1 · 一页读懂 */}
      <section className="cb-band alt">
        <div className="wrap">
          <div className="sec-head">
            <span className="eyebrow reveal">一页读懂</span>
            <h2 className="cb-h2 reveal">我们与贵区在谈的,是一件什么事</h2>
          </div>
          ...
          <p className="cb-quote reveal">这不是采购 AI 服务,是与贵区<span className="grad">共建一个本地 AI 产业</span>。</p>
        </div>
      </section>
      ...
      <section className="cb-band">
        <div className="wrap">
          <div className="sec-head">
            ...
            <h2 className="cb-h2 reveal">AI 落地最快的,正是国有物业</h2>
            <p className="sub reveal">国有物业 AI 化,既是政府用场景换产业最大的一块底盘,也是当下 AI 与机器人最真实的商用战场。</p>
          </div>
          <div className="grid c2" style={{ marginTop: "48px" }}>
            <div className="card reveal"><div className="k"></div><h3>无处不在的底盘</h3><p>办公园区、商业综合体、人才公寓、医院、学校、工业厂区——贵区几乎每一栋楼都在物业管理覆盖之内。这是政府用场景换产业最大的一块底盘。</p></div>
            <div className="card reveal"><div className="k"></div><h3>城市治理的最后一公里</h3><p>物业是城市治理触达居民、企业、园区的毛细血管。它已从「管理」升级为「服务」,纳入国家级民生议题。</p></div>
            <div className="card reveal"><div className="k"></div><h3>人力越重,AI 杠杆越长</h3><p>物业是典型的劳动密集行业,中基层每天在做大量高频、标准、可量化的管理动作;人力越重的地方,AI 能撬动的空间就越大。</p></div>
            <div className="card reveal"><div className="k"></div><h3>AI 机器人最大的商用场景</h3><p>商用清洁、安保、巡检乃至人形机器人,当前几乎都在物业场景里跑。这是 AI 在物理世界第一块真正跑通的商业版图。</p></div>
          </div>
        </div>
      </section>
      ...
      <section className="cb-core">
        <div className="cb-grid" aria-hidden="true"></div>
        <div className="wrap">
          <div className="sec-head">
            <span className="eyebrow reveal">以投带产 · 核心模式</span>
            <h2 className="cb-h2 on-dark reveal">不是卖给贵区一套系统,是把一个产业投到本地</h2>
          </div>
          <div className="dcards">
            <div className="dcard reveal"><div className="k"></div><h3>贵方零投入</h3><p>不采购设备、不投入固定资产、不承担技术风险。国企 / 园区按 FM 服务合同付费,且持平或低于现有物业支出。</p></div>
            <div className="dcard reveal"><div className="k"></div><h3>我们出资、出技术、出团队</h3><p>在本地注册子公司、本地纳税、本地招聘;运维与技术团队常驻,持续运营与迭代。</p></div>
            <div className="dcard reveal"><div className="k"></div><h3>产业留在本地</h3><p>产业、税收、就业与数据资产沉淀在本地;一个项目跑通,辖区内的楼宇与园区可快速复制。</p></div>
          </div>
      ...
      <section className="cb-band alt">
        <div className="wrap">
          <div className="sec-head">
            ...
            <h2 className="cb-h2 reveal">五年后,贵区会培育出一家什么样的 AI 公司</h2>
          ...
          <div className="stagebar reveal"><i></i><i></i><i></i></div>

          <div className="grid c3" style={{ marginTop: "54px" }}>
            <div className="card reveal"><div className="k"></div><h3>一家本地 AI 企业</h3><p>子公司注册在本地,工商税务、营收与税收归属本地,持续运营。</p></div>
            <div className="card reveal"><div className="k"></div><h3>机器人与具身智能载体</h3><p>区域领先的服务机器人与具身智能商用运营能力,沉淀在本地。</p></div>
            <div className="card reveal"><div className="k"></div><h3>多业态数据资产</h3><p>跨业态沉淀的结构化数据,成为本地数据要素的源头。</p></div>
          </div>
        </div>
      </section>
      ...
      <section className="cb-band">
        <div className="wrap">
          <div className="sec-head">
            ...
            <h2 className="cb-h2 reveal">剩下的,见面详谈</h2>
