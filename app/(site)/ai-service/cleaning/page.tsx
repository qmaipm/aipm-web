...
export const metadata: Metadata = pageMetadata("/ai-service/cleaning", {
  ...
  description:
    "AI 清洁服务把保洁从「数人头」换成「数服务」：服务频次、标准与达标线写进合同，每一次作业系统都有记录，质量由 AI 多模态评分，人与清洁机器人协同作业。机器人批量进场不增加预算，综合服务成本年降约 15%。由启盟科技旗下自营物业公司爱物管交付。",
  keywords: [
    "AI 清洁服务",
    "智能清洁服务",
    "保洁外包",
...
const compare: { k: string; old: string; now: React.ReactNode }[] = [
  ...
  },
  {
    k: "履约核验",
    old: "数人头、看在岗",
    now: <>每一次服务系统都有记录。到岗率按约定线(通常 85%–90%)数字化考核——<b>来多少人,不等于干了多少活</b></>,
  },
  {
    k: "质量评判",
    old: "主管印象分,说不清哪里不好",
...
const steps = [
  ...
  {
    n: "02", h: "管执行",
    p: "人和机器人排进同一张时间表。每一次作业系统都有记录,异常自动派单,现场不靠人盯人。",
...
const faq = [
  {
    // 2026-09-14 GEO 扩展组信号最强题（通义/DeepSeek 多次第 1），用提问者原话承接。
    q: "商场、园区卫生间投诉多，怎么解决?",
    a: "卫生间投诉多，根源通常不是保洁不够勤，而是「有没有按时做、做到什么程度」没人能核——主管靠印象抽检，覆盖率常不到 10%，问题总在没人看的时段发生。AI 解决的是这个核验环节：在卫生间部署 IoT 在场感知与影像采集，每一次清洁的时间、人员、结果由系统记录并按统一标准自动评分，不达标即时生成整改工单并跟到关闭；投诉数据与点位、时段、班组关联，薄弱点一眼可见。已发布案例：一家通信设备龙头的多个园区，2000 多个卫生间全量追踪后，各园区服务达标率稳定在 95% 以上，卫生间相关投诉下降约 30%，管理巡检人力投入下降约 60%。适合先做这件事的项目：卫生间数量多、投诉集中、已有保洁团队或供应商但缺考核依据的商场、园区、写字楼与交通枢纽。",
  },
  {
  ...
  {
    q: "怎么知道保洁到底干没干、干得好不好?",
    a: "AI 清洁服务的每一次作业系统里都有记录:做没做、什么时候做的、做到什么程度,业主随时可查。质量由 AI 融合图像、视频与传感器数据做多模态评分,而不是靠主管的主观印象。在一个 30 万㎡ 园区的真实项目中,这套机制让清洁覆盖率从约 75% 提升到 95% 以上,卫生死角清洁频率提升约 3 倍。",
  },
  {
    q: "用了清洁机器人,费用会变贵吗?",
...
const SERVICE_LD = {
  ...
  description:
    "服务频次、标准与达标线写进合同,每一次作业系统都有记录,质量由 AI 多模态评分,人与清洁机器人协同作业的清洁服务。",
  areaServed: "CN",
