...
const faq = [
  ...
  {
    q: "AI 清洁服务的收费和考核怎么约定?",
    a: "报价明码标价,包含人员、机器人、AI 系统与物料四个部分。考核全部量化并写进合同:每月服务次数、服务标准、到岗率(通常约定 85%–90%)、现场 AI 评分线(如不低于 4 分),以及重大投诉、满意度调查等传统条款。做不到约定,按合同扣钱。我们不接受的只有一种考核:说不清具体哪里不好的主观评判。",
  },
  {
      ...
      <section className="av-band">
        <div className="wrap">
          ...
          <div className="avc-stand reveal">
            ...
            <p>
              我们不接受的只有一种：<b>「服务质量不好」，但说不清具体哪里不好。</b>这种模棱两可，你大概也受够了。
            </p>
          </div>
        </div>
      </section>
