...
export const metadata: Metadata = {
  ...
  description:
    "换一家物业公司,往往只是换一批人——考核方式、透明程度、响应逻辑都没变。我们换的是方式本身:清洁、设施设备、安保、客服四大工种真实交付,干没干数据会说话;客服管家什么都可以问,从来不藏着掖着;服务指标写进合同,接受 100% 量化考核。由启盟科技旗下自营物业公司爱物管交付,服务 WeWork、佳都科技、八马茶业、万益蓝等客户。",
  keywords: [
    "AI 物业服务",
    "换物业公司要注意什么",
    "如何选物业公司",
...
const compare: { k: string; old: string; now: React.ReactNode }[] = [
  ...
  },
  {
    k: "透明程度",
    old: "问「今天做了什么」,答不上来",
    now: <>专属客服管家<b>什么都可以问</b>:今天多少人上班、这个月计划什么——从来不藏着掖着</>,
  },
  {
    k: "响应逻辑",
    old: "投诉了才动,催一次动一下",
...
const faq = [
  {
    ...
    a: "根本区别不在人,在方式:一是可查——清洁、设施设备、安保四大工种的每一次作业都沉淀为数据,干没干、干得好不好,数据会说话;二是透明——每一位客户都有专属 AI 客服管家,今天多少人上班、这个月计划做什么,什么都可以问,从来不藏着掖着;三是主动——系统主动预警、主动处置,在问题变成投诉之前就处理掉;四是敢承诺——服务指标直接写进合同,接受 100% 量化考核与处罚。这项服务由启盟科技旗下自营物业公司爱物管交付。",
  },
  {
    q: "换物业公司要注意什么?",
    ...
    <main className="aisv avtrade avhub">
      ...
      <section className="av-hero">
        ...
        <div className="wrap av-hero-top">
          ...
          <p className="av-lead reveal">
            换一家物业公司，往往只是换一批人——考核的方式、透明的程度、响应的逻辑，都没有变。我们换的是<b>方式本身</b>：干没干数据会说话，什么都可以问，指标写进合同。
          </p>
      ...
      <section className="avc-end">
        ...
        <div className="wrap">
          ...
          <div className="av-cta reveal">
            <Link href="/contact" className="btn btn-primary">联系我们 <Arrow /></Link>
            <span className="alt">或先看 <Link href="/cases/aipm-property-ai-transformation">爱物管自己的故事</Link></span>
          </div>
        </div>
      </section>
    </main>
