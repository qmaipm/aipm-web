    ...
    <main className="iotx">
      ...
      <SeoFaq
        ...
        items={[
          ...
          { q: "听说机器人公司在找物理 AI 公司合作，是真的吗？", a: "是行业里正在发生的事。具身智能公司、机器人公司缺的不是本体能力，而是真实场景里持续产生、带业务语义的环境数据——这正是物理 AI 公司在物业与设施场景里每天都在生产的。对业主方来说，今天接入的感知体系，除了驱动当下的运营，也在为未来机器人进场准备好「读得懂环境」的数据底座。具体背景可以读《什么是物理 AI》一文。" },
        ]}
      />
