...
export default function Page() {
  return (
    <CaseShell slug="30w-park-ai-property-manager-robot">
      ...
      <CaseFriction
        title="换一批人就要重讲一遍"
        expected="业主方支持推进，服务模式跑通之后就能稳定运行。"
        actual="物业管理公司的管理人员更换频繁，每换一批就要重新对齐认知。全 AI 的管理方式和传统模式完全不同，考核口径也不同，若新管理层沿用传统考核，各方都会不适应。"
        resolution="把责权边界先划清楚，考核统一以数字化结果为准。边界和口径写在明处，人员变动就不会让共识每次归零。"
      />
