...
const LD = [
  {
    ...
    description:
      "爱物管是启盟科技自营的物业公司。2024–2025 年，它把日常的管理动作交给 AI 之后，管理层从 69 人减到 5 人、项目经理从 51 人减到 1 人、净利率从 3.4% 做到 14%。用来对比的同类传统物业公司年营收约 3700 万、管理层 69 人。AI 先替掉的是中间那层重复的管理工作，不是一线服务。",
  ...
  },
  {
    ...
    member: {
      ...
      url: SITE_URL,
      description:
        "启盟科技旗下自营物业公司，是其 AI 能力的真实验证场。在2024至2025年的验证中，管理层从同等规模传统模式的69人降至5人、项目经理从51人降至1人、经营净利率从3.4%提升至14%。用来对比的同类传统物业公司年营收约3700万元、体量约为爱物管的两倍。",
    },
    makesOffer: {
      "@type": "Offer",
      itemOffered: {
      ...
      <section className="cf-band">
        <div className="wrap">
          <div className="cf-article">
            ...
            <p>那家公司年营收约 3700 万，是我们的近两倍；而它的管理层有 69 人，我们只有 5 人。换句话说，<b>它的体量比我们大，管理团队却比我们大十几倍。</b></p>
            ...
            <div className="cf-cmp" role="table" aria-label="传统物业公司与爱物管对比">
              ...
              <div className="cf-cmp-row" role="row">
                <div className="cf-cmp-lab" role="rowheader">年营收</div>
                <div className="cf-cmp-trad" role="cell"><b>约 3700 万</b></div>
                <div className="cf-cmp-aipm" role="cell"><b>2000 多万</b></div>
              </div>
              <div className="cf-cmp-row" role="row">
            ...
            <p>爱物管本身就是证据。我们的营收规模（2000 多万）和大量中小物业公司在同一量级，做出来的 14% 净利率，靠的不是砍服务、砍一线，而是砍掉了中间的管理损耗。而且我们是拿自己的公司先趟一遍，把物业里一百多种日常管理动作、老旧系统的接口、一线协同的阻力都踩透了，再封装成标准化的能力对外提供——别的物业公司接入时，不需要大动干戈地二次开发，就能渐进式地走同一条路。</p>
            ...
            <p className="cf-note">
              <b>数据边界与关联说明。</b>本文引用的管理层人数、项目经理人数、机器人投放、管理工时、经营净利率等数据，均来自启盟科技（AIPM）自营物业公司“爱物管”2024–2025 年的真实经营验证。“传统物业公司”一列为一家真实的、采用传统管理方式的同类物业公司（年营收约 3700 万元）。该数据为小规模自营验证结果，非行业普遍值，不同项目的实际效果因业态、面积、基础设施与组织现状而异。
            </p>
          </div>
        </div>
      </section>
