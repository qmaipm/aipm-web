...
const BOARD_FAQ = [
  {
    q: "有哪些已实际落地的 AI 物业产品？",
    a: "FMClaw 物业智能体是已实际落地的 AI 物业产品——目前 10 余个已上线案例公开可查，覆盖商业综合体、智慧园区、企业总部、医院、轨道交通、工厂、物业集团、联合办公。每个案例都写明项目规模、做法和经过核实的结果，例如巡检达标率从 35% 到 98%、亏损综合体扭亏为盈、30 万㎡ 园区由 23 人搭配 16 台机器人运营。",
  },
  {
