...
const GROUPS: {
  ...
  },
  {
    ...
    what: "这四个项目的共同问题是巡检走过场、检查记录经不起查、不知道现场到底怎么样。看它们怎么把「每一次巡检都真实发生」变成可核验的事实：医疗级服务标准、地铁机房日修日检、危化区域双人双岗巡查，以及监控数据不出内网时 AI 怎么用上。",
    slugs: ["intl-hospital-medical-grade-fm", "metro-3400-rooms-daily-inspection", "hazardous-area-dual-person-patrol", "campus-cctv-photo-ai-review"],
  },
  {
    id: "for-group",
    ...
    <main className="solcase">
      ...
      <section className="ca-hero">
        ...
        <div className="wrap ca-hero-top">
          ...
          <p className="ca-lead">不是演示，而是<b>已经交付、正在运行</b>的部署——每个案例都写明项目规模、做法、结果，以及<b>什么情况下不适合照着做</b>。</p>
