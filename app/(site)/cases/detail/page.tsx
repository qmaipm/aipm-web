    ...
    <main className="case-detail">
      ...
      <section className="phero">
        ...
        <div className="wrap">
          ...
          <h1 className="reveal">一个项目，跑成了自治运营</h1>
      ...
      <section className="band alt">
        <div className="wrap">
          ...
          <div className="grid c2 reveal" style={{ marginTop: "48px", maxWidth: "var(--measure)" }}>
            <div className="card"><span className="k vi-bar"></span><h3>运营管理 Agent</h3><p>统一接管日常调度与异常判断,处理口径一致、可追溯。</p></div>
            <div className="card"><span className="k vi-bar"></span><h3>质量评估 Agent</h3><p>按统一标准核查服务结果,问题自动归集、自动派单。</p></div>
          </div>
          ...
          <p className="note-line reveal">
            同款 Agent 与能力详见{" "}
            <Link href="/solutions/operations">运营管理 Agent</Link>。
          </p>
        </div>
      </section>
      ...
      {/* CLIENT VOICE — 唯一暗场签名段 */}
      <section className="band dark">
        <div className="wrap">
          <span className="eyebrow reveal">客户原声</span>
          <p className="voice reveal">
      ...
      <section className="band">
        <div className="wrap">
          ...
          <div className="grid c3 reveal" style={{ marginTop: "48px" }}>
            <div className="card"><span className="k vi-bar"></span><h3>先接一个真实业务</h3><p>从一项日常运营开始接入,而不是一次性全量上线。</p></div>
            <div className="card"><span className="k vi-bar"></span><h3>沉淀成可复用工作流</h3><p>跑通的判断与派发固化下来,成为可搬运的模板。</p></div>
            <div className="card"><span className="k vi-bar"></span><h3>复制到相似项目</h3><p>同类综合体、写字楼按同一套基座接入,边界逐步扩大。</p></div>
          </div>
        </div>
      </section>
