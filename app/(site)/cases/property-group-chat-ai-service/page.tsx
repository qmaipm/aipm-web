...
export default function Page() {
  return (
    <CaseShell slug="property-group-chat-ai-service">
      ...
      <CaseFriction
        title="客服先感到的是压力"
        expected="把群消息自动成单，是替客服卸下最重复的那部分活，团队应该马上松一口气。"
        actual="上线初期客服和一线工程反而感到压力变大：过去漏掉的诉求现在一条不落地冒出来，每件没按时完成的事都有人跟进，团队很不适应。"
        resolution="没有回退，让数据跑满一段时间。团队随后看到录入和督办的活确实少了、信息不再漏，员工满意度也涨上来，压力感才转成认可。"
      />
