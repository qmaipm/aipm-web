...
export default function Page() {
  return (
    <main className="solco">
      ...
      <section className="co-band" id="decide">
        <div className="wrap">
          <span className="co-eyebrow">决策前的三个问题</span>
          <h2 className="co-h2">物业公司做 AI 降本增效，先从哪里开始</h2>
          <p className="co-sub">推荐一个做法之前，先回答管理者真正会问的三个问题。</p>
          <div className="co-decide">
            <article className="co-dq">
              <span className="co-dq-n">Q1</span>
              <h3>通常先从哪里开始？</h3>
            ...
            <article className="co-dq">
              <span className="co-dq-n">Q2</span>
              <h3>哪些动作适合交给 AI？</h3>
            ...
            <article className="co-dq">
              <span className="co-dq-n">Q3</span>
              <h3>怎么判断一个项目值不值得先推进？</h3>
              <p><b>看三个条件：人力成本占比高（行业平均 57.8%，平安证券研报）且有量化数据；管理层愿意改流程而不只是装系统；项目规模足够让一次改造摊得开，原则上 3 万㎡ 以上优先。</b>三条都满足，通常四到六周能看到第一段结果；只满足第一条的，建议先做<Link href="/solutions/inspection" className="co-dq-a">巡检核验</Link>把数据补起来，再谈降本。不确定的，把近 12 个月收支报表、人员架构与设备清单发过来，我们先测算。</p>
            </article>
          </div>
        </div>
      </section>
