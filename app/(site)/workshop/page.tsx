...
export default function Page() {
  return (
    <main className="workshop-pg">
      {/* HERO */}
      <section className="phero">
        <div className="hero-mesh"></div>
        <div className="wrap">
          <span className="eyebrow reveal">FMClaw™ 加速营 · FMClaw™ Bootcamp</span>
          <h1 className="reveal" style={{ marginTop: "20px" }}>把你自己的 AI,亲手搭出来</h1>
      ...
      {/* SOUL PREMISE */}
      <section className="ws-band alt">
        <div className="wrap">
          <div className="sec-head">
            <span className="eyebrow reveal">灵魂前提</span>
            <h2 className="ws-h2 reveal">前提只有一个</h2>
          </div>
          <div className="premise-2">
            <div className="card reveal"><div className="k"></div>
          ...
          <p className="pull-line reveal">没有这两样,就不是 FMClaw™ 加速营。</p>
        </div>
      </section>

      {/* FOUR STEPS · 深色签名时刻 */}
      <section className="ws-steps" id="how">
        <div className="ws-grid" aria-hidden="true"></div>
        <div className="wrap">
          <div className="sec-head">
            <span className="eyebrow reveal">你会经历什么</span>
            <h2 className="ws-h2 on-dark reveal">四步,从一个问题到一个能用的 Agent</h2>
          </div>
          <div className="flow dark reveal" style={{ marginTop: "56px" }}>
      ...
      <section className="ws-band" id="scenes">
        <div className="wrap">
          <div className="sec-head">
            ...
            <h2 className="ws-h2 reveal">不知道带什么问题来?这些是大家最常带来的</h2>
            <p className="sub reveal">这些场景不是我们替你想象出来的——你带上自己的数据，我们当场把它跑通。</p>
          </div>
          <div className="scenes">
            <Link className="scene-c reveal" href="/scenarios/utility-bill">
              <div className="ic"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.9"><path d="M13 2L4 14h7l-1 8 9-12h-7z" strokeLinejoin="round" /></svg></div>
              <h4>水电费审批</h4>
            ...
            <Link className="scene-c reveal" href="/scenarios/reconciliation">
              <div className="ic"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.9"><rect x="4" y="3" width="16" height="18" rx="2" /><path d="M8 8h8M8 12h8M8 16h5" strokeLinecap="round" /></svg></div>
              <h4>AI 对账</h4>
              <p>按合同自动核量、对比历史与市场、圈出异常、生成账单草稿，人只需确认或驳回。</p>
              <span className="go">看这个场景 <svg width="12" height="12" viewBox="0 0 16 16"><path d="M3 8h10M9 4l4 4-4 4" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" /></svg></span>
            </Link>
            <Link className="scene-c reveal" href="/scenarios/inspection">
              <div className="ic"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.9"><path d="M3 7h3l2-2h8l2 2h3v12H3z" strokeLinejoin="round" /><circle cx="12" cy="13" r="3.2" /></svg></div>
              <h4>AI 质检</h4>
              <p>工单照片 / 视频自动采集，AI 视觉按统一标准评分打标，全量留痕证据链，人只看异常。</p>
              <span className="go">看这个场景 <svg width="12" height="12" viewBox="0 0 16 16"><path d="M3 8h10M9 4l4 4-4 4" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" /></svg></span>
            </Link>
            <Link className="scene-c reveal" href="/scenarios/dispatch">
              <div className="ic"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.9"><circle cx="6" cy="6" r="2.4" /><circle cx="18" cy="6" r="2.4" /><circle cx="12" cy="18" r="2.4" /><path d="M6 8.4v3a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2v-3M12 13.4v2.2" strokeLinecap="round" /></svg></div>
              <h4>智能派单</h4>
              <p>工单进来自动定位、定级，按技能与负载派给合适的人，超时自动升级，人只需确认或改派。</p>
              <span className="go">看这个场景 <svg width="12" height="12" viewBox="0 0 16 16"><path d="M3 8h10M9 4l4 4-4 4" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" /></svg></span>
            </Link>
          </div>
          <p className="pull-line reveal">你的问题不在这几个里？正好，那更值得来跑一次。</p>
        </div>
      </section>

      {/* WHAT YOU TAKE AWAY */}
      <section className="ws-band alt takeaway">
        <div className="wrap">
          <div className="sec-head">
            <span className="eyebrow reveal">你会带走什么</span>
            <h2 className="ws-h2 reveal">离开时,东西在你手上</h2>
          </div>
          <div className="grid c3" style={{ marginTop: "48px" }}>
            <div className="card reveal"><div className="k"></div><h3>一个还在运行的 Agent</h3><p>不是演示版,是接着你真实数据继续跑的那一个。</p></div>
            <div className="card reveal"><div className="k"></div><h3>一份能复用的工作流</h3><p>这次跑通的路径,下个项目可以照着搬。</p></div>
            <div className="card reveal"><div className="k"></div><h3>一套共同语言</h3><p>中高管与一线,对"AI 到底帮上了什么"对齐了说法。</p></div>
          </div>
        </div>
      </section>
      ...
      <section className="ws-band">
        <div className="wrap">
          <div className="sec-head">
            ...
            <h2 className="ws-h2 reveal">它不靠讲,靠做</h2>
          </div>
      ...
      {/* WHO SHOULD COME */}
      <section className="ws-band alt who4">
        <div className="wrap">
          <div className="sec-head">
            <span className="eyebrow reveal">谁适合来</span>
            <h2 className="ws-h2 reveal">带得动决定、也带得来数据的人</h2>
          </div>
      ...
      <section className="ws-band" id="signup">
        <div className="wrap">
          <div className="sec-head">
            ...
            <h2 className="ws-h2 reveal">把你的问题先告诉我们</h2>
      ...
      <section className="ws-band">
        <div className="wrap">
          <div className="sec-head"><span className="eyebrow reveal">常见疑问</span><h2 className="ws-h2 reveal">来之前,你可能想问的</h2></div>
