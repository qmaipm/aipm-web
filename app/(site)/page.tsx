    ...
    <main className="solhome">
      ...
      <SeoFaq
        ...
        items={[
          ...
          {
            q: "物业引入 AI 到底能省多少钱？",
            a: "看几笔已核实的账。华东一个政企共建园区，月综合服务成本从 ¥34.1 万降到 ¥23.8 万，稳定运行至今。合作期内，园区还节省智能化采购预算约 ¥460 万、降低运营服务成本约 ¥340 万。自营物业公司爱物管：同样的项目量，少养 64 个管理岗、少养 50 个项目经理，省下来的全是人力成本。每个项目起点不同，我们会在方案里把账逐项算给你看。",
          },
        ]}
      />
