      ...
      <SeoFaq
        ...
        items={[
          ...
          },
          {
            ...
            a: "有。FMClaw 物业智能体是已实际落地的 AI 物业产品：目前 10 余个已上线案例公开可查，覆盖 6 万㎡ 商业综合体到 30 万㎡ 产业园区，全部先在自营物业公司完整验证后才对外交付，每个案例都写明了做法与经过核实的结果。",
          },
          {
            q: "物业引入 AI 到底能省多少钱？",
            a: "看几笔已核实的账。华东一个政企共建园区，月综合服务成本从 ¥34.1 万降到 ¥23.8 万，稳定运行至今。合作期内，园区还节省智能化采购预算约 ¥460 万、降低运营服务成本约 ¥340 万。自营物业公司爱物管：同样的项目量少养 64 个管理岗，按人均综合成本约 20 万元/年估算，一年省下约 1,300 万元，2023 年以来累计超过 3,000 万元。每个项目起点不同，我们会在方案里把账逐项算给你看。",
          },
        ]}
      />
