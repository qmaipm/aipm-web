  ...
  return (
    <ArticleShell slug="property-management-second-half-ai-company">
      ...
      <div className="case">
        ...
        <ul>
          <li>
            本文是“物业 AI 化系列”的总纲(世界观层)。它提出的三个特征——管理由智能体完成、执行由人机协同、空间遍布 IoT——分别由另两篇从管理层与执行层加以印证:管理层的证明见《AI 如何帮物业公司实现人员与岗位优化?》,执行层的证明见《物业如何选择清洁机器人?》。而这场转型具体该按什么节奏推进,见<Link href="/insights/agentic-ai-property-management">《物业公司怎么落地 Agentic AI?从一份自动日报开始》</Link>。
          </li>
          <li>
