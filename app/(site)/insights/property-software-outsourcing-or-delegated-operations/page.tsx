...
export const metadata = articleMetadata("property-software-outsourcing-or-delegated-operations", {
  title: "物业系统、单项外包与委托运营怎么选？业主决策指南 | 启盟科技",
  description: "从日常经营由谁组织、采购标的、现场责任和结果考核出发，比较物业系统采购、保洁等单项外包与 AI 物业委托运营。附业主决策问题及签约前责任清单，不把软件采购等同于经营责任转移。",
});
...
const models = [
  ...
  { name: "委托运营", buy: "约定范围内的日常经营与管理服务", run: "运营方组织日常经营；业主保留约定审批与监督", check: "服务品质、经营指标、账目与责任履行" },
];
...
export default function Page() {
  return (
    <ArticleShell slug="property-software-outsourcing-or-delegated-operations" variant="delegated">
      ...
      <h2>希望交出日常经营，再讨论委托运营</h2>
      <p><b>委托运营适合讨论的是：谁持续组织项目经营，而不只是某项工作由谁做。</b>如果业主不愿长期组织排班、供应商协调、成本优化和系统迭代，就需要评估是否把这些工作放进同一运营委托范围。</p>
      <p>按启盟公布的 AI 物业代运营模式，业主方保留项目主体、收款账户和重大事项决定权。运营方投入 AI 系统、机器人及运营团队，负责约定范围内的日常经营，并接受服务与经营数据考核。</p>
      ...
      <p>本篇不重复展开资金与收益分配。相关安排见<Link href="/insights/who-pays-for-property-ai">“项目上 AI，这笔钱该谁出”</Link>及<Link href="/ai-service/delegated-operation">代运营服务说明</Link>。具体投资、酬金和考核条件需要按项目测算并写入正式文件。</p>
      ...
      <p>三种方式可以组合：委托运营项目仍会使用系统，也可能继续采购外包服务。关键是项目层面的整合责任由谁承担，而不是合同数量多少。</p>
