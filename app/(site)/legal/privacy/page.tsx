      ...
      <section className="band lg-body">
        <div className="wrap">
          <article className="prose reveal">
            ...
            <h2 id="project-intake">物业委托管理项目报备专用说明</h2>
            <p>项目报备由广州启盟科技有限公司受理。为评估、查重、联系和确认合作，我们处理您主动提交的联系方式、项目资料及评分输入。资料保存在非公开受理台账，由有权限的受理人员处理；通知邮件仅包含受理编号，不发送经营资料。</p>
            <p>请仅提交有权提供的必要信息。首轮不上传完整合同、身份证或无关客户资料。提交前请阅读<Link href="/partners/delegated-operation/project#data-notice">报备表内的资料使用说明</Link>。如需查询、更正、删除或撤回同意，请联系 liuziwen@aipm.cn 或 020-8985 3580，核验身份后按适用要求处理。</p>
