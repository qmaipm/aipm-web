  ...
  return (
    <main className="scenario-page sc-green">
      ...
      <BeforeAfter
        ...
        metricAfter="一句话拿结果"
        before={[
          { st: "提问", h: "领导问一句", p: "“A 楼上月能耗为什么超标？”", tag: "层层转交" },
          { st: "找数据", h: "助理找工程经理导 Excel", p: "比对历史、排查原因、写说明。", tag: "慢 · 数据陈旧" },
          { st: "转述", h: "助理把分析转回领导", p: "口头转述结论。", tag: "可能失真 · 解读不一" },
        ]}
        after={[
          { st: "提问", h: "领导在钉钉直接 @ Bot", p: "还是那个常用对话框。", tag: "不换工具" },
          { st: "归因", h: "底层 数据→模型→Skill", p: "能耗归因在底层完成，用户无感。", tag: "秒级" },
          { st: "答复", h: "带异常明细的回答 + 简报", p: "结果回到原对话框，可继续追问。", tag: "有原因 · 可动作" },
        ]}
        gains={[
